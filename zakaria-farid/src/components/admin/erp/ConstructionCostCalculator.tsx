...
export const ConstructionCostCalculator: React.FC<ConstructionCostCalculatorProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', direction: isAr ? 'rtl' : 'ltr' }}>
            ...
            <button
              ...
              style={{
                background: calculatorMode === 'BUILT_PROPERTY_PRICING' 
                  ...
                  : 'transparent',
                color: calculatorMode === 'BUILT_PROPERTY_PRICING' ? '#080c14' : '#cbd5e1',
                border: 'none',
                borderRadius: '8px',
            ...
            <button
              ...
              style={{
                background: calculatorMode === 'FEASIBILITY_ESTIMATOR' 
                  ? 'linear-gradient(135deg, #d4af37 0%, #b8860b 100%)' 
                  : 'transparent',
                color: calculatorMode === 'FEASIBILITY_ESTIMATOR' ? '#080c14' : '#cbd5e1',
                border: 'none',
                borderRadius: '8px',
                padding: '0.5rem 0.9rem',
                fontSize: '0.78rem',
      ...
      {/* ========================================================================= */}
      {/* MODE 1: ACTUAL BUILT PROPERTY PRICING (THE USER'S PRIMARY REQUEST)        */}
      {/* ========================================================================= */}
      {calculatorMode === 'BUILT_PROPERTY_PRICING' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                <label style={{ fontSize: '0.82rem', fontWeight: 800, color: '#d4af37', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  <Building2 size={16} />
            ...
            <div style={{
              background: 'linear-gradient(135deg, rgba(212, 175, 55, 0.08) 0%, rgba(13, 18, 28, 0.9) 100%)',
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ fontSize: '0.76rem', color: '#cbd5e1', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.4rem' }}>
                <span style={{ fontSize: '1.65rem', fontWeight: 900, color: '#f8fafc', fontFamily: 'monospace' }}>
                  {formatEGP(propertyAudit.totalLoggedCost)}
                </span>
                <span style={{ fontSize: '0.85rem', color: '#d4af37', fontWeight: 800 }}>ج.م</span>
              </div>
              ...
              <div style={{
                ...
                <div>
                  <span style={{ color: '#94a3b8' }}>{isAr ? 'تكلفة المتر المنفذة الفعلية:' : 'Actual Cost / Sqm:'}</span>
                  <div style={{ color: '#60a5fa', fontWeight: 800, marginTop: '0.15rem' }}>
                    {formatEGP(propertyAudit.costPerSqm)} ج.م/م²
                  </div>
                </div>
                <div>
                  <span style={{ color: '#94a3b8' }}>{isAr ? 'المساحة المبنية الإجمالية:' : 'Total Built-up Area:'}</span>
                  <div style={{ color: '#e2e8f0', fontWeight: 800, marginTop: '0.15rem' }}>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                <label style={{ fontSize: '0.82rem', fontWeight: 800, color: '#e2e8f0', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              ...
              <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.35rem', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <strong style={{ color: '#38bdf8' }}>{formatEGP(builtPricing.marketBenchmarkValue)} ج.م</strong>
              </div>
            </div>

            {/* Step 3: Target Profit Money (نسبة أو مبلغ مقطوع) */}
            <div>
              <label style={{ fontSize: '0.82rem', fontWeight: 800, color: '#e2e8f0', display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', marginBottom: '0.75rem' }}>
                <button
                  ...
                  style={{
                    background: profitMode === 'PERCENTAGE' ? 'rgba(16, 185, 129, 0.15)' : 'rgba(255, 255, 255, 0.03)',
                    border: `1px solid ${profitMode === 'PERCENTAGE' ? '#10b981' : 'rgba(255, 255, 255, 0.08)'}`,
                    borderRadius: '8px',
                    padding: '0.5rem',
                    color: profitMode === 'PERCENTAGE' ? '#34d399' : '#94a3b8',
                    fontSize: '0.76rem',
                    fontWeight: 700,
                    cursor: 'pointer',
                    display: 'flex',
                ...
                <button
                  ...
                  style={{
                    background: profitMode === 'FIXED_AMOUNT' ? 'rgba(16, 185, 129, 0.15)' : 'rgba(255, 255, 255, 0.03)',
                    border: `1px solid ${profitMode === 'FIXED_AMOUNT' ? '#10b981' : 'rgba(255, 255, 255, 0.08)'}`,
                    borderRadius: '8px',
                    padding: '0.5rem',
                    color: profitMode === 'FIXED_AMOUNT' ? '#34d399' : '#94a3b8',
                    fontSize: '0.76rem',
                    fontWeight: 700,
                    cursor: 'pointer',
                    display: 'flex',
              ...
              {profitMode === 'PERCENTAGE' ? (
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                    <span style={{ fontSize: '0.74rem', color: '#cbd5e1' }}>{isAr ? 'نسبة هامش الربح المستهدف:' : 'Profit Margin %:'}</span>
                    <span style={{ fontSize: '0.82rem', fontWeight: 800, color: '#34d399' }}>{targetProfitPercent}%</span>
                  </div>
                  <input
                    type="range"
                    min="10"
                    ...
                    {[20, 25, 30, 35, 40, 50].map((pct) => (
                      <button
                        ...
                        style={{
                          ...
                          padding: '0.3rem 0',
                          borderRadius: '6px',
                          background: targetProfitPercent === pct ? '#10b981' : 'rgba(255, 255, 255, 0.04)',
                          color: targetProfitPercent === pct ? '#080c14' : '#cbd5e1',
                          border: 'none',
                          fontSize: '0.72rem',
                          fontWeight: 700,
                          cursor: 'pointer'
              ...
              <div style={{
                ...
                <span style={{ color: '#cbd5e1' }}>{isAr ? 'صافي مبلغ الربح المحسوب:' : 'Calculated Net Profit:'}</span>
          ...
          <div style={{
            background: 'linear-gradient(180deg, rgba(212, 175, 55, 0.08) 0%, rgba(18, 22, 34, 0.95) 100%)',
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', margin: '0.5rem 0' }}>
                <span style={{ fontSize: '2.4rem', fontWeight: 900, color: '#ffffff', letterSpacing: '-0.02em', lineHeight: 1 }}>
                  {formatEGP(builtPricing.estimatedSellingPrice)}
                </span>
                <span style={{ fontSize: '1.1rem', color: '#d4af37', fontWeight: 800 }}>ج.م</span>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', flexWrap: 'wrap' }}>
                <div style={{
                  ...
                  <strong style={{ color: '#38bdf8' }}>{formatEGP(builtPricing.estimatedSellingPricePerSqm)} ج.م/م²</strong>
                </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem' }}>
                <span style={{ color: '#cbd5e1' }}>{isAr ? 'إجمالي المنصرف الفعلي المسجل (C):' : 'Total Incurred Cost (C):'}</span>
                <span style={{ fontWeight: 800, color: '#ffffff' }}>{formatEGP(builtPricing.totalLoggedCost)} ج.م</span>
              </div>

              {/* Row 2: Target Profit Money */}
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem' }}>
                <span style={{ color: '#34d399' }}>{isAr ? 'مبلغ الربح المستهدف المضاف (P):' : 'Target Profit Money (P):'}</span>
                <span style={{ fontWeight: 800, color: '#34d399' }}>+{formatEGP(builtPricing.targetProfitMoney)} ج.م</span>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', fontWeight: 800 }}>
                <span style={{ color: '#d4af37' }}>{isAr ? 'سعر البيع الإجمالي التقديري:' : 'Total Selling Price:'}</span>
                <span style={{ color: '#d4af37' }}>{formatEGP(builtPricing.estimatedSellingPrice)} ج.م</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: '1.25rem', fontWeight: 900, color: '#d4af37' }}>
            ...
            {selectedProperty && (
              <div style={{
                ...
                <div>
                  <span style={{ color: '#94a3b8', display: 'block' }}>{isAr ? 'سعر القائمة الحالي في الكتالوج:' : 'Current Catalog Price:'}</span>
                  <span style={{ fontWeight: 800, color: '#ffffff' }}>{formatEGP(selectedProperty.price_egp)} ج.م</span>
                </div>
                <div style={{ textAlign: isAr ? 'left' : 'right' }}>
                  <span style={{ color: '#94a3b8', display: 'block' }}>{isAr ? 'الفارق مع السعر التقديري:' : 'Variance vs Estimated:'}</span>
                  <span style={{
                    fontWeight: 800,
                    color: D(builtPricing.estimatedSellingPrice).gte(selectedProperty.price_egp || 0) ? '#34d399' : '#f87171'
                  }}>
            ...
            {onUpdateSellingPrice && selectedProperty && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: 'auto' }}>
                <button
                  ...
                  style={{
                    background: priceUpdateSuccess 
                      ...
                      : 'linear-gradient(135deg, #d4af37 0%, #b8860b 100%)',
                    color: priceUpdateSuccess ? '#ffffff' : '#080c14',
                    border: 'none',
                    borderRadius: '10px',
                    padding: '0.85rem',
                    fontSize: '0.88rem',
                ...
                >
                  {priceUpdateSuccess ? <CheckCircle2 size={18} /> : <Sparkles size={18} />}
                  <span>
                    {isUpdatingPrice 
                      ? (isAr ? 'جاري تحديث السعر في قاعدة البيانات...' : 'Updating Database...') 
                      : priceUpdateSuccess 
                        ? (isAr ? 'تم اعتماد وتحديث سعر البيع بالكتالوج بنجاح!' : 'Selling Price Updated in Catalog!') 
                        : (isAr ? 'اعتماد وتحديث سعر البيع في كتالوج العقارات' : 'Apply & Update Selling Price in Catalog')}
                  </span>
                </button>
              </div>
            )}
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }}>
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        background: buildingPricingMode === 'whole' ? 'rgba(212, 175, 55, 0.2)' : 'transparent',
                        color: buildingPricingMode === 'whole' ? 'var(--zf-gold, #d4af37)' : '#94a3b8',
                        border: buildingPricingMode === 'whole' ? '1px solid rgba(212, 175, 55, 0.4)' : '1px solid transparent',
                        borderRadius: '6px',
                    ...
                    <button
                      ...
                      style={{
                        background: buildingPricingMode === 'units' ? 'rgba(56, 189, 248, 0.2)' : 'transparent',
                        color: buildingPricingMode === 'units' ? '#38bdf8' : '#94a3b8',
                        border: buildingPricingMode === 'units' ? '1px solid rgba(56, 189, 248, 0.4)' : '1px solid transparent',
                        borderRadius: '6px',
                        padding: '0.35rem 0.75rem',
                        fontSize: '0.75rem',
                        fontWeight: 700,
                ...
                <div style={{
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
                    <thead>
                      <tr style={{ background: 'rgba(255, 255, 255, 0.04)', color: '#94a3b8', textAlign: isAr ? 'right' : 'left' }}>
                    ...
                    <tbody>
                      {buildingUnitsPricing.units.map((u, idx) => (
                        <tr key={u.unit_id || idx} style={{ borderTop: '1px solid rgba(255, 255, 255, 0.05)', background: idx % 2 === 0 ? 'transparent' : 'rgba(255, 255, 255, 0.01)' }}>
                          <td style={{ padding: '0.65rem 0.85rem', fontWeight: 800, color: '#ffffff' }}>{u.unit_number}</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#cbd5e1' }}>{isAr ? `الدور ${u.floor}` : `Floor ${u.floor}`}</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#cbd5e1' }}>{u.area_sqm} م²</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#f59e0b', fontWeight: 700 }}>{formatEGP(u.apportionedCost)} ج.م</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: u.unitTaxesPaid > 0 ? '#38bdf8' : '#94a3b8', fontWeight: 700 }}>
                            {u.unitTaxesPaid > 0 ? `${formatEGP(u.unitTaxesPaid)} ج.م` : (isAr ? '٠ ج.م' : '0 EGP')}
                          </td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#e2e8f0', fontWeight: 800 }}>{formatEGP(u.totalApartmentCost)} ج.م</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: 'var(--zf-gold, #d4af37)', fontWeight: 900 }}>{formatEGP(u.suggestedPrice)} ج.م</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#94a3b8' }}>{formatEGP(u.pricePerSqm)} ج.م</td>
                          <td style={{ padding: '0.65rem 0.85rem', color: '#10b981', fontWeight: 700 }}>{u.grossMargin}%</td>
                          <td style={{ padding: '0.65rem 0.85rem' }}>
                            <span style={{
                              ...
                              fontSize: '0.7rem',
                              fontWeight: 700,
                              background: u.status === 'contracted' ? 'rgba(16, 185, 129, 0.15)' : 'rgba(212, 175, 55, 0.15)',
                              color: u.status === 'contracted' ? '#34d399' : '#d4af37',
                              border: u.status === 'contracted' ? '1px solid rgba(16, 185, 129, 0.3)' : '1px solid rgba(212, 175, 55, 0.3)'
                            }}>
      ...
      {/* ========================================================================= */}
      {/* MODE 2: PRE-CONSTRUCTION FEASIBILITY ESTIMATOR (The Engineering Model)    */}
      {/* ========================================================================= */}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <div style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.08)', paddingBottom: '0.75rem' }}>
              <span style={{ fontSize: '0.82rem', fontWeight: 800, color: 'var(--zf-gold, #d4af37)', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <Hammer size={16} />
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#d4af37' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}>
                <span style={{ color: '#94a3b8' }}>{isAr ? 'أطنان حديد التسليح (B500D):' : 'Steel Rebar:'}</span>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}>
                <span style={{ color: '#94a3b8' }}>{isAr ? 'خرسانة مسلحة رتبة C35:' : 'Ready-mix Concrete C35:'}</span>
                <span style={{ fontWeight: 800, color: '#ffffff' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}>
                <span style={{ color: '#94a3b8' }}>{isAr ? 'أجور مصنعيات الهيكل الإنشائي:' : 'Skeleton Labor:'}</span>
                <span style={{ fontWeight: 800, color: '#ffffff' }}>{formatEGP(feasibilityCalculations.totalLaborCost)} ج.م</span>
              </div>

              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}>
                <span style={{ color: '#94a3b8' }}>{isAr ? 'تأسيس الكهروميكانيك (MEP):' : 'MEP Infrastructure:'}</span>
                <span style={{ fontWeight: 800, color: '#ffffff' }}>{formatEGP(feasibilityCalculations.totalMepCost)} ج.م</span>
              </div>

              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}>
                <span style={{ color: '#94a3b8' }}>{isAr ? 'التشطيبات المعمارية المختارة:' : 'Architectural Finishing:'}</span>
                <span style={{ fontWeight: 800, color: '#ffffff' }}>{formatEGP(feasibilityCalculations.totalFinishingCost)} ج.م</span>
              </div>

              <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '0.5rem', display: 'flex', justifyContent: 'space-between', fontSize: '0.82rem', fontWeight: 800 }}>
                <span style={{ color: 'var(--zf-gold, #d4af37)' }}>{isAr ? 'إجمالي تكلفة البناء والتشييد (WIP):' : 'Total Construction (WIP):'}</span>
                <span style={{ color: 'var(--zf-gold, #d4af37)' }}>{formatEGP(feasibilityCalculations.totalConstructionWip)} ج.م</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: '0.7rem', color: '#93c5fd', display: 'block' }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: '0.7rem', color: '#6ee7b7', display: 'block' }}>
