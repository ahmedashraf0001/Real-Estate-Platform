            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              {(() => {
                const collectionRate = D(totalGrossContractValue).isZero() 
                  ? 0 
                  : D(totalCollectedCash).div(totalGrossContractValue).times(100).toNumber();
                ...
                return (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem' }}>
                    {/* Tile 1: Gross Portfolio */}
                    <div 
                      onClick={() => setActiveTab('contracts')}
                      title={isAr ? 'الانتقال إلى محفظة العقود' : 'Inspect Contract Portfolio'}
                      style={cardBaseStyle}
                      onMouseEnter={e => {
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                          <span style={{ fontSize: '0.8rem', color: '#cbd5e1', fontWeight: 700, display: 'block' }}>
                            {isAr ? 'إجمالي قيمة التعاقدات (V)' : 'Gross Contract Portfolio (V)'}
                          </span>
                          <span style={{ fontSize: '0.68rem', color: '#64748b' }}>
                            {isAr ? 'محفظة العقود السارية' : 'Booked pipeline'}
                          </span>
                        </div>
                        <div style={{
                          width: '34px',
                      ...
                      <div style={{ margin: '0.75rem 0 0.4rem 0' }}>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.35rem' }}>
                          <span style={{ fontSize: '1.75rem', fontWeight: 800, color: '#f8fafc', letterSpacing: '-0.02em', fontFamily: 'monospace' }}>
                            {formatCleanWholeNumber(totalGrossContractValue)}
                          </span>
                      ...
                      <div style={{ fontSize: '0.7rem', color: '#64748b', borderTop: '1px solid rgba(255, 255, 255, 0.04)', paddingTop: '0.45rem' }}>
                        <span style={{ color: '#cbd5e1', fontWeight: 600 }}>{data.contracts.length}</span> {isAr ? 'عقود بيع سارية وموثقة بالدفاتر' : 'active contracts booked'}
                      </div>
                    </div>

                    {/* Tile 2: Cash Collected */}
                    <div 
                      onClick={() => setActiveTab('pdc')}
                      title={isAr ? 'الانتقال إلى الشيكات والخزينة' : 'Inspect Cash & PDCs'}
                      style={cardBaseStyle}
                      onMouseEnter={e => {
                        e.currentTarget.style.transform = 'translateY(-2px)';
                        e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.2)';
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                          <span style={{ fontSize: '0.8rem', color: '#cbd5e1', fontWeight: 700, display: 'block' }}>
                            {isAr ? 'النقدية المحصلة فعلياً (C)' : 'Total Cash Collected (C)'}
                          </span>
                          <span style={{ fontSize: '0.68rem', color: '#64748b' }}>
                            {isAr ? 'سيولة نقدية وخزينة مستقرة' : 'Cleared & liquid'}
                          </span>
                        </div>
                        <div style={{
                          width: '34px',
                      ...
                      <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.04)', paddingTop: '0.45rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.68rem', color: '#64748b', marginBottom: '0.25rem' }}>
                          <span>{isAr ? 'نسبة التحصيل الفعلي من المحفظة' : 'Realized collection'}</span>
                          <span style={{ color: '#cbd5e1', fontWeight: 700 }}>{collectionRate.toFixed(1)}%</span>
                        </div>
                        <div style={{ width: '100%', height: '3px', background: 'rgba(255, 255, 255, 0.06)', borderRadius: '999px', overflow: 'hidden' }}>
                          <div style={{ width: `${Math.min(100, Math.max(0, collectionRate))}%`, height: '100%', background: '#cbd5e1', borderRadius: '999px' }} />
                        </div>
                      </div>
                    </div>

                    {/* Tile 3: Deferred Revenue */}
                    <div 
                      onClick={() => setActiveTab('calculator')}
                      title={isAr ? 'الانتقال إلى حاسبة العقود' : 'Inspect Installment Schedule'}
                      style={cardBaseStyle}
                      onMouseEnter={e => {
                        e.currentTarget.style.transform = 'translateY(-2px)';
                        e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.2)';
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                          <span style={{ fontSize: '0.8rem', color: '#cbd5e1', fontWeight: 700, display: 'block' }}>
                            {isAr ? 'إيرادات مؤجلة (203000)' : 'Deferred Revenue (203000)'}
                          </span>
                          <span style={{ fontSize: '0.68rem', color: '#64748b' }}>
                            {isAr ? 'مقبوضات قبل التسليم' : 'Pre-handover advances'}
                          </span>
                        </div>
                        <div style={{
                          width: '34px',
                      ...
                      <div style={{ margin: '0.75rem 0 0.4rem 0' }}>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.35rem' }}>
                          <span style={{ fontSize: '1.75rem', fontWeight: 800, color: '#f8fafc', letterSpacing: '-0.02em', fontFamily: 'monospace' }}>
                            {formatCleanWholeNumber(deferredRevenue)}
                          </span>
                          <span style={{ fontSize: '0.74rem', fontWeight: 600, color: '#64748b' }}>
                            {isAr ? 'ج.م' : 'EGP'}
                          </span>
                      ...
                      <div style={{ fontSize: '0.7rem', color: '#64748b', borderTop: '1px solid rgba(255, 255, 255, 0.04)', paddingTop: '0.45rem' }}>
                        {isAr ? 'التزام تعاقدي مؤجل لحين التسليم (IFRS 15)' : 'Contract liability per IFRS 15'}
                      </div>
                    </div>

                    {/* Tile 4: Total Incurred WIP */}
                    <div 
                      onClick={() => setActiveTab('cost-allocation')}
                      title={isAr ? 'الانتقال إلى رسملة الأعمال و RSV' : 'Inspect WIP & RSV Allocation'}
                      style={cardBaseStyle}
                      onMouseEnter={e => {
                        e.currentTarget.style.transform = 'translateY(-2px)';
                        e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.2)';
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                          <span style={{ fontSize: '0.8rem', color: '#cbd5e1', fontWeight: 700, display: 'block' }}>
                            {isAr ? 'أعمال تحت التنفيذ (WIP)' : 'Total Incurred WIP (150-156)'}
                          </span>
                          <span style={{ fontSize: '0.68rem', color: '#64748b' }}>
                            {isAr ? 'تكاليف إنشائية مرسملة' : 'Capitalized project assets'}
                          </span>
                        </div>
                        <div style={{
                          width: '34px',
                      ...
                      <div style={{ margin: '0.75rem 0 0.4rem 0' }}>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.35rem' }}>
                          <span style={{ fontSize: '1.75rem', fontWeight: 800, color: '#f8fafc', letterSpacing: '-0.02em', fontFamily: 'monospace' }}>
                            {formatCleanWholeNumber(totalWipIncurred)}
                          </span>
                          <span style={{ fontSize: '0.74rem', fontWeight: 600, color: '#64748b' }}>
                            {isAr ? 'ج.م' : 'EGP'}
                          </span>
                      ...
                      <div style={{ fontSize: '0.7rem', color: '#64748b', borderTop: '1px solid rgba(255, 255, 255, 0.04)', paddingTop: '0.45rem' }}>
                        {isAr ? 'مخزون تطوير عقاري ورسملة من حسابات ١٠٥٠٠٠' : 'GL 105000 capitalized inventory'}
                      </div>
                    </div>
                  </div>
                );
